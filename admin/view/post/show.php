    		...
    		<div class="modal-content">
      			...
      			<div class="modal-body col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
        			<form action="" method="POST" class="form-horizontal" role="form">
        					...
        					<div class="form-group">
                                <label>Tiêu đề</label>
                                <input type="txt" readonly="true" class="form-control" id="title" placeholder="Tiêu đề">
                            </div>
                            
                            <div class="form-group">
                                <label>Nội dung</label>
                                <input type="txt" readonly="true" class="form-control" id="content" placeholder="Nội dung">
                            </div>
