						...
						<div class="left-blog left-single">
							<div class="blog-left">
								<div class="single-left-left wow fadeInUp animated" data-wow-delay=".5s">
									<p>Posted By <a href="#"><?php echo $user['name']; ?></a> &nbsp;&nbsp; on <?php echo $data['created_at']; ?> &nbsp;&nbsp; <a href="#">Comments (10)</a></p>
									<img src="/ZentGroupEx/BuoiHoc/Project_PhamThiHue_php08/admin/view/images/<?php echo $data['thumbnail']; ?>" alt="" />
								</div>
